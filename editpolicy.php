                    ...
                    <div class="card-header">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                            <a href="policyholders.php?id=<?= $leaddata['id']; ?>" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="code.php" method="POST">
                                    ...
                                    <div class="input-group input-group-sm mr-3">
                                        ...
                                        <input type="date" name="datecreated" value="<?=$leaddata['datecreated'];?>"  class="form-control m-3" >
