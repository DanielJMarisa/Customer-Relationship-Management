            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>View Polcy Holder
                            <a href="policyholders.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="code.php" method="POST" disabled>
                                    ...
                                    <div class="input-group input-group-sm mr-3">
                                        ...
                                        <input type="date" name="datecreated" value="<?=$leaddata['datecreated'];?>"  class="form-control m-3" disabled>
                                    ...
                                    <div class="input-group input-group-sm mr-3">
                                        <label>Lead Status: </label><input type="taxt" name="leadstatus" method="post" value="<?=$leaddata['leadstatus'];?>" class="form-control m-3" disabled>

                                        <label>Insurer: </label>
                                        <input type="text" name="insurer" value="<?=$leaddata['insurer'];?>"  class="form-control m-3" disabled>
                                    </div>
                                    ...
                                    <div class="input-group input-group-sm mr-3">
                                        ...
                                        <input type="text" name="installationdate" value="<?=$leaddata['installationdate'];?>"  class="form-control m-3" disabled>
